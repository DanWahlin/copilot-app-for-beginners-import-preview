...
1. Click the dropdown icon next to the **Create** button and select **Create and run**.
   ...
   ![New automation form with filled details](assets/new-automation.webp)
...
When you enable **Run in cloud**, a **Tools** dropdown appears. Each tool grants the cloud agent a specific capability — pushing changes, updating labels, creating a PR, and so on.

![Cloud automation Tools selector with Read issue, List issues, and Search issues selected, showing 3 tools selected while write actions are unchecked](assets/app-automation-cloud-tools.webp)
